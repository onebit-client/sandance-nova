...
export function Topbar(props: Props) {
  const zeroResults =
    props.selectionState.selectedData &&
    props.selectionState.selectedData.length === 0;
  ...
  const items: FluentUITypes.ICommandBarItemProps[] = [
    {
      ...
      disabled:
        disabled || props.historyItems.length === 0 || props.historyIndex === 0,
      onClick: props.undo,
    },
    {
      key: "redo",
      ...
      disabled:
        ...
        props.historyIndex >= props.historyItems.length - 1,
      onClick: props.redo,
    },
    {
      key: "deselect",
    ...
    },
    {
      ...
      onClick: () =>
        props.doFilter(
          props.selectionSearch,
          strings.labelHistoryFilterIsolate,
        ),
    },
    {
      key: "exclude",
      ...
      onClick: () =>
        props.doFilter(
          SandDance.searchExpression.invert(props.selectionSearch),
          strings.labelHistoryFilterIExclude,
        ),
    },
    {
      key: "reset",
  ...
  farItems.push({
    ...
    title:
      props.view === "2d" ? strings.labelViewType3d : strings.labelViewType2d,
            ...
            CommandBarButton: {
              styles: (buttonProps: FluentUITypes.IButtonProps) => {
                buttonProps.theme.palette =
                  props.themePalette as FluentUITypes.IPalette;
