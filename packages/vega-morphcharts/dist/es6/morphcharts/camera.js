...
export function applyCameraCallbacks(ref, lastPresenterConfig, lastView, transistion2dOnly) {
...
export function setTransitionTimeAxesVisibility(transistion2dOnly, core) {
